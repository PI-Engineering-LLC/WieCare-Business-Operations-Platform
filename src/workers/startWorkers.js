...
async function triggerNow() {
  ...
  // const jobId4 = await boss.send('monthly-inspection-reminder-job', { manualTrigger: true });
  // const jobId5 = await boss.send('daily-invoice-reminder-job', { manualTrigger: true });

  // const jobId3 = await boss.send('monthly-training-reminder-job', { manualTrigger: true });
  // const jobId = await boss.send('daily-overdue-invoice-job', { manualTrigger: true });
  const jobId2 = await boss.send('daily-overdue-hold-job', { manualTrigger: true });
  // console.log(`Job sent with ID: ${jobId} # ${jobId2}`);
  // console.log(`Job sent with ID:  ${jobId5}`);
}
...
module.exports = { startWorkers, stopWorkers, triggerNow };
